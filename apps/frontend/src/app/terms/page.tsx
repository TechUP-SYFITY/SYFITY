...
const sections = [
  ...
  [
    '제3조 (약관의 효력 및 변경)',
    '서비스는 이 약관을 서비스 화면에 게시하여 효력을 발생시키며, 관련 법령에 어긋나지 않는 범위에서 변경할 수 있습니다. 약관을 변경하는 경우 변경된 내용을 서비스 화면에 게시하고, 별도 고지가 필요한 경우 관련 법령에 따릅니다.',
  ],
  [
    '제4조 (서비스의 제공)',
  ...
  [
    ...
    '서비스는 YouTube API 서비스를 이용합니다. 이용자는 YouTube 서비스 약관의 적용을 받으며, YouTube 플레이어·검색 기능 이용 중 Google/YouTube가 처리하는 정보는 개인정보처리방침에서 안내합니다. Room에 참여하면 호스트의 재생·일시정지·곡 변경에 따라 이용자 화면에서도 재생이 자동으로 시작될 수 있으며, 이용자는 이 약관 동의로 이에 동의합니다. 영상 재생 가능 여부와 광고 노출은 YouTube 정책 및 영상 소유자 설정에 따릅니다.',
  ],
  [
    '제7조 (연령 확인)',
    '서비스는 만 14세 미만 아동을 대상으로 하지 않습니다. 이용자는 최초 로그인 시 만 14세 이상임을 체크박스로 확인해야 하며, 허위 확인 시 서비스는 필요한 조치를 취할 수 있습니다.',
  ],
  [
    '제8조 (이용자의 의무)',
