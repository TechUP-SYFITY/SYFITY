  ...
  return (
    <section className="relative z-10 mx-auto grid w-full max-w-6xl grid-cols-1 items-center gap-12 px-4 pt-32 pb-20 sm:px-6 lg:grid-cols-2 lg:gap-8 lg:pt-40 lg:pb-28">
      <div className="max-w-xl">
        ...
        <h1
          className="animate-rise mt-6 text-4xl leading-tight font-bold tracking-tight text-white sm:text-5xl lg:text-6xl"
        ...
        <p
          className="animate-rise mt-6 text-base leading-relaxed text-white/55 sm:text-lg"
        ...
        <div className="animate-rise mt-8" style={{ animationDelay: '360ms' }}>
      ...
      <div className="flex justify-center lg:justify-end">
        <Image
          ...
          className="animate-rise h-auto w-full max-w-sm rounded-2xl shadow-[0_0_60px_rgba(114,244,164,0.12),0_0_120px_rgba(136,92,246,0.08)]"
        />
      </div>
    </section>
  );
