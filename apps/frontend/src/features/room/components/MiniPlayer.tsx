...
export function MiniPlayer({
  ...
  return (
    <footer className="fixed inset-x-0 bottom-0 z-20 flex min-h-16 shrink-0 items-center gap-4 border-t border-border bg-background/95 px-5 pb-[env(safe-area-inset-bottom)] backdrop-blur xl:static xl:h-room-mini-player xl:min-h-0 xl:px-6 xl:pb-0">
