...
export function MiniPlayer({
  ...
  return (
    <footer className="fixed inset-x-0 bottom-0 z-20 flex h-16 shrink-0 items-center gap-4 border-t border-border bg-background/95 px-5 backdrop-blur xl:static xl:h-20 xl:px-6">
