...
export function RoomLayout({
  ...
  return (
    <section className="relative flex min-h-0 flex-1 flex-col overflow-hidden border-b border-border xl:flex-row">
      ...
      <div
        className="shrink-0 px-5 py-4 xl:min-w-0 xl:self-stretch xl:border-r xl:border-border xl:p-6 landscape:flex landscape:min-h-0 landscape:flex-1 landscape:flex-col landscape:py-0"
