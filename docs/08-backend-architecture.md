...
| `VERCEL_PREVIEW_ORIGIN_PATTERN`             | 선택값. 특정 Vercel 프로젝트/팀 Preview URL만 매칭하는 정규식. 예: `^https://syfity-frontend-[a-z0-9-]+-techup-syfity\\.vercel\\.app$`. 미설정 또는 잘못된 정규식이면 Preview origin을 허용하지 않는다 |
